...
echo ""
echo "🖼️  oh-my-images (AI image generation) — optional:"
echo "   Set API keys to enable AI-generated images in presentations"
echo "   export GOOGLE_API_KEY='your-key'       # Nanobanana / Google Imagen 3 (default)"
echo "   export OPENAI_API_KEY='your-key'       # OpenAI (gpt-image-1, DALL-E 3)"
echo "   export STABILITY_API_KEY='your-key'    # Stability AI (Stable Diffusion)"
echo ""
